...
def simple_multi_model(layer1Size, layer2Size):
    #Inputs
...
def trainEvalAndSaveModel(model_name, size1, size2,lr = 0.001, epochs = 5):
    ...
    iModel, loss_model = simple_multi_model(size1,size2)
...
combos = [("multiplication_fs_300_100_lr_001", 300, 100, 0.001)]
